//Dateiname: Aufgabe3_Spiele.c
//Version: v1.0
//Autoren: Lars Rippert & Fiona Wilhelm 
//Datum: 29.06.2025
//Beschreibung: Das Programm ist das Spiel Blackjack
...
/*
Ziel: Wilkommenheißen, des Users, durchführen des Spiels und ausführen von anderen Funktionen
...
/*
Ziel: Ziehen einer Karte aus dem Deck

Parameter: Array deck

Rückgabe: eine Karte aus dem Deck zurückgeben und 0 setzen (gezogen)
*/
...
/*
Ziel: Zug des spielers und des dealers ausführen, überprüfung der gezogenen Karten

Parameter: spielerdeck, dealerdeck, deck
...
/*
Ziel: Anzahl der Karten ausgeben (karten die nicht 0 sind)

Parameter: "handkarten" vom Spieler oder Dealer

Rückgabe: Anzahl der Karten
*/
...
/*
Ziel: Ausrechnen des Gesamtwerts und drucken von Buchstaben auf der Konsole

Parameter: Anzahlkarten, "handkarten" vom Spieler oder Dealer

Rückgabe: int gesamtwert der Karten
*/
...
/*
Ziel: Ausgeben des Layouts auf der Konsole

Parameter: karten des spielers, karten des dealers, deck, Gesamtpunktzahl (Spieler oder Dealer)
...
/*
Ziel: "Löschen" der Karten von Spieler und dealer falls neu gespielt wird

Parameter: karten, die gelöscht werden sollen
...
/*
Ziel: Integer Wert einlesen

Parameter: -

Rückgabe: Eingelesener Int-Wert
*/
